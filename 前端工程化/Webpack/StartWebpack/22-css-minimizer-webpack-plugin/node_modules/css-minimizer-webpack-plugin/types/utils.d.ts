...
export type Input = import("css-minimizer-webpack-plugin").Input;
export type RawSourceMap = import("@jridgewell/trace-mapping").EncodedSourceMap;
export type MinimizedResult = import("css-minimizer-webpack-plugin").MinimizedResult;
export type CustomOptions = import("css-minimizer-webpack-plugin").CustomOptions;
...
export function cssnanoMinify(
  ...
  minimizerOptions?: import("css-minimizer-webpack-plugin").CustomOptions | undefined,
