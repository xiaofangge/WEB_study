...
var wujie = (0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
    ...
    setup: function setup(props, param) {
        ...
        // 监听，name和url会变，需要重新绑定
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.watch)([
            props.name,
            props.url
        ], function() {
            wujie__WEBPACK_IMPORTED_MODULE_1__.bus.$onAll(handleEmit);
            init();
        });
        // 初始化无界
        var init = function() {
        ...
        (0,vue__WEBPACK_IMPORTED_MODULE_0__.onBeforeUnmount)(function() {
            wujie__WEBPACK_IMPORTED_MODULE_1__.bus.$offAll(handleEmit);
        });
        return function() {
